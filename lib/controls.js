export const CONTROLS = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    relatedThreats: ["healthcare", "legal", "financial"],
  ...
  // ─────────────────────────────────────────────
  {
    ...
    lastReviewed: "2026-04",
    relatedThreats: ["legal", "financial"],
    ...
    industryNotes: {
      ...
      financial:
        "The GLBA Safeguards Rule requires access controls that include authentication mechanisms. FTC Safeguards Rule citation: https://www.ftc.gov/business-guidance/privacy-security/safeguards-rule FFIEC guidance specifies that financial institutions should implement password policies commensurate with the risk of the systems being protected. PCI-DSS Requirement 8.2 mandates unique IDs and strong authentication for all users accessing cardholder data.",
      retail:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    industryNotes: {
      ...
      financial:
        "The GLBA Safeguards Rule requires financial institutions to restrict access to customer information to authorized personnel only. FTC Safeguards Rule citation: https://www.ftc.gov/business-guidance/privacy-security/safeguards-rule Segregation of duties is a core principle. No single individual should be able to initiate and approve financial transactions. SOX compliance for publicly traded companies requires documented access controls over financial reporting systems.",
      retail:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    industryNotes: {
      ...
      financial:
        "PCI-DSS Requirement 3.4 requires rendering of primary account numbers (PAN) unreadable wherever they are stored, with strong cryptography as the preferred method. GLBA's Safeguards Rule requires encryption of customer data in transit over external networks. FTC Safeguards Rule citation: https://www.ftc.gov/business-guidance/privacy-security/safeguards-rule Banking regulators expect encryption to be the default for all sensitive financial data.",
      retail:
  ...
  // ─────────────────────────────────────────────
  {
    slug: "data-backup",
    lastReviewed: "2026-04",
    relatedThreats: ["healthcare", "financial"],
  ...
  // ─────────────────────────────────────────────
  {
    ...
    industryNotes: {
      ...
      financial:
        "FFIEC guidance requires financial institutions to assess the risks of mobile devices, including personal devices used for business purposes. GLBA's Safeguards Rule requires controls over all systems accessing customer information. FTC Safeguards Rule citation: https://www.ftc.gov/business-guidance/privacy-security/safeguards-rule Financial institutions must ensure that BYOD devices meet the same security standards as corporate devices.",
      retail:
