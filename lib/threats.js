...
const financial = {
  ...
  industryDescription:
    "BEC, phishing, ransomware, and regulatory obligations explained for accountants, bookkeepers, tax preparers, and financial advisors.",
  tldr: "If your business prepares tax returns, manages client payroll, handles bookkeeping, advises on investments, or processes any kind of consumer financial data, you are legally classified as a financial institution under federal law, and you are subject to the FTC Safeguards Rule whether you know it or not. Cyberattacks on accounting firms have surged 300% since 2020. The average cost of a financial services data breach reached $6.08 million in 2024. This page covers the threats most likely to hit your firm and the regulatory obligations most small firms are not meeting.",
...
<p>The FTC Safeguards Rule applies to every tax preparer, bookkeeper, financial advisor, accountant, mortgage broker, and credit counselor in the United States. It requires a written information security program with nine specific elements, including a designated qualified individual responsible for the program, a documented risk assessment, access controls, encryption, MFA, staff training, an incident response plan, and regular testing. The penalty for non-compliance is up to $51,744 per violation per day. The breach notification requirement, effective May 2024, requires firms to report breaches affecting 500 or more consumers to the FTC within 30 days, and those reports will be made public.</p>
...
<p>The Gramm-Leach-Bliley Act (GLBA) is the statute underlying the Safeguards Rule and applies broadly to businesses engaged in financial activities. If you handle other people's financial data for a living, GLBA applies to you.</p>
<p>The FTC's own plain-language guidance explicitly lists tax preparation firms, financial advisors, credit counselors, mortgage brokers, collection agencies, and investment advisors among the covered entities. If you are unsure whether your firm is covered, the safer assumption is that you are.</p>
<p>For a plain-English walkthrough of what the FTC Safeguards Rule requires from your firm, see our compliance resources.</p>

<h2>Take the Next Step</h2>
<p>This page gives you the picture. Our free cybersecurity assessment tells you where your firm specifically stands against these threats and maps your results to FTC Safeguards Rule requirements.</p>`,
  faqs: [
    {
      question: "Does the FTC Safeguards Rule apply to my bookkeeping firm?",
      answer:
        "If your firm handles client financial data, prepares tax returns, processes payroll, or provides financial advisory services, the answer is almost certainly yes. The FTC Safeguards Rule defines \"financial institution\" broadly to include tax preparers, accountants, bookkeepers, credit counselors, mortgage brokers, and financial advisors. The Rule explicitly lists 13 categories of covered businesses. Firms with records for fewer than 5,000 consumers are exempt from some requirements but are still subject to the Rule's core obligations.",
    },
    {
      question: "What happens if I am not in compliance with the Safeguards Rule?",
      answer:
        "The FTC has civil penalty authority with fines up to $51,744 per violation per day. Beyond fines, a breach tied to a Safeguards Rule failure can trigger state attorney general investigations, class-action lawsuits, mandatory remediation, and public disclosure of the breach through the FTC's reporting database. The reputational damage of a public breach report for a firm whose business depends on client trust can be permanent.",
    },
    {
