export const SECTIONS = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        tooltip: {
          explanation:
            "An authentication policy defines rules for passwords, MFA, session timeouts, and lockout thresholds. Mature policies align with NIST 800-63 and are enforced technically, not just on paper.",
          insurerNote:
  ...
  // ──────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        tooltip: {
          explanation:
            "GLBA's Safeguards Rule and various state laws require financial institutions to notify regulators, customers, and sometimes law enforcement within specific timeframes after a data breach. Preparation includes pre-drafted templates, legal counsel on retainer, and documented escalation paths.",
          insurerNote:
  ...
  // ──────────────────────────────────────────────
  // 9. Vendor & Third-Party Risk (ID.SC)
  // ──────────────────────────────────────────────
  {
    ...
    questions: [
      {
        ...
        tooltip: {
          explanation:
            "The GLBA Safeguards Rule requires financial institutions to develop, implement, and maintain a comprehensive information security program. The updated rule (effective June 2023) added specific requirements including a qualified individual, written risk assessments, and encryption.",
          insurerNote:
            "GLBA non-compliance exposes the organization to regulatory action and may affect coverage. Insurers expect documented compliance with the updated Safeguards Rule requirements.",
      ...
      },
      {
        ...
        tooltip: {
          explanation:
            "Cybersecurity risk assessments identify threats, vulnerabilities, and their potential business impact. For financial institutions, this should cover regulatory risk, operational risk, and technology risk aligned with frameworks like NIST CSF or FFIEC CAT.",
          insurerNote:
      ...
      },
      {
        ...
        tooltip: {
          explanation:
            "Board reporting on cybersecurity ensures that leadership has visibility into the organization's risk posture, major threats, and security investment effectiveness. The GLBA Safeguards Rule requires reporting to the board or governing body.",
          insurerNote:
