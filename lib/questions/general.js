/**
 * General Business - NIST CSF 2.0 + CIS Controls Questionnaire
 *
...
export const SECTIONS = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        tooltip: {
          explanation:
            "A password policy defines rules like minimum length, complexity, and rotation. Modern guidance (NIST SP 800-63B) favors longer passphrases over frequent rotation and bans known-breached passwords.",
          insurerNote:
            "Weak or outdated password policies are flagged in underwriting questionnaires. Policies aligned with current NIST SP 800-63B guidance demonstrate security awareness.",
  ...
  // ──────────────────────────────────────────────
  // 7. Vendor & Third-Party Risk (GV.SC)
  // ──────────────────────────────────────────────
  {
    id: "vendor_risk",
