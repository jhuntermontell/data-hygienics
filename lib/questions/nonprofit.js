/**
 * Nonprofit / Church / Parish - NIST CSF 2.0 + IRS Cybersecurity Guidelines Questionnaire
 *
...
export const SECTIONS = [
  ...
  // ──────────────────────────────────────────────
  // 8. Vendor & Third-Party Risk (GV.SC)
  // ──────────────────────────────────────────────
  {
    id: "np_vendor_risk",
  ...
  // ──────────────────────────────────────────────
  {
    id: "np_infrastructure",
    title: "Infrastructure Health",
    nistCategory: "ID.AM",
    questions: [
      {
        key: "np_infra_workstation_age",
