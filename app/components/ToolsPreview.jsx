...
export const activeTools = [
  ...
  },
  {
    ...
    body: "Built from NIST and SANS frameworks. Customized to your company. Downloaded as a branded PDF.",
  ...
  },
  {
    ...
    body: "What each control means, why it matters, and whether your business needs it.",
    cta: "Browse Controls",
    href: "/controls",
  },
  {
...
export const comingSoonTools = [
  {
    ...
    body: "Plain-English security reviews of the tools your business already uses. No sponsorships. No affiliate links.",
  },
  {
    icon: LifeBuoy,
  ...
  },
  {
    ...
    body: "Every term you've nodded along to in a meeting but never actually understood. Plain English. No condescension.",
  },
  {
    icon: ClipboardList,
