...
export const activeTools = [
  ...
  },
  {
    ...
    body: "Build a personalized incident response plan, test it with interactive tabletop exercises, and generate the documentation your insurance carrier wants to see.",
    cta: "Build Your Plan",
    href: "/tools/ir-plan",
  },
  {
    ...
    body: "What each control means, why it matters. You determine if your business needs it.",
    cta: "Browse Controls",
    href: "/controls",
  },
  {
